// Rule (thin line) rendering — same as line shader but simplified.
// Reuses the line shader; this file provides the same pipeline.
// Rules are just batched line instances with uniform stroke.
...
struct RuleInstance {
    ...
    @location(2) params: vec4<f32>,     // width, 0, 0, 0
};
