...
mod tests {
    ...
    fn clip_roundtrip_safetensors() {
        ...
        // Patch embed
        entries.push((
            "visual.conv1.weight".into(),
            F32View::new(
                &original.vit.patch_embed.proj.to_vec(),
                original.vit.patch_embed.proj.shape.dims(),
            ),
        ));
        entries.push((
            "visual.class_embedding".into(),
            F32View::new(&original.vit.cls_token.to_vec(), &[d]),
        ));
        entries.push((
            "visual.positional_embedding".into(),
            F32View::new(
                &original.vit.pos_embed.to_vec(),
                original.vit.pos_embed.shape.dims(),
            ),
        ));
        ...
        entries.push((
            ...
            F32View::new(&b.ln1_gamma.to_vec(), &[d]),
        ));
        entries.push((
            format!("{bp}.ln_1.bias"),
            F32View::new(&b.ln1_beta.to_vec(), &[d]),
        ));
        ...
        entries.push((
            ...
            F32View::new(&b.attn.qkv_bias.to_vec(), &[3 * d]),
        ));
        ...
        entries.push((
            ...
            F32View::new(&b.attn.proj_bias.to_vec(), &[d]),
        ));
        entries.push((
            format!("{bp}.ln_2.weight"),
            F32View::new(&b.ln2_gamma.to_vec(), &[d]),
        ));
        entries.push((
            format!("{bp}.ln_2.bias"),
            F32View::new(&b.ln2_beta.to_vec(), &[d]),
        ));
        ...
        entries.push((
            ...
            F32View::new(&b.mlp.fc1_bias.to_vec(), &[d_ff]),
        ));
        ...
        entries.push((
            ...
            F32View::new(&b.mlp.fc2_bias.to_vec(), &[d]),
        ));

        // LN post
        entries.push((
            "visual.ln_post.weight".into(),
            F32View::new(&original.vit.ln_post_gamma.to_vec(), &[d]),
        ));
        entries.push((
            "visual.ln_post.bias".into(),
            F32View::new(&original.vit.ln_post_beta.to_vec(), &[d]),
        ));

        // Projection matrix
        entries.push((
            "visual.proj".into(),
            F32View::new(&original.proj.to_vec(), original.proj.shape.dims()),
        ));
        ...
        let path =
            std::env::temp_dir().join(format!("scry_test_{}_clip.safetensors", std::process::id()));
        ...
        assert_eq!(
            original.vit.cls_token.to_vec(),
            loaded.vit.cls_token.to_vec()
        );
        assert_eq!(
            original.vit.pos_embed.to_vec(),
            loaded.vit.pos_embed.to_vec()
        );
    }
